        ...
        <div className="flex flex-col gap-4">
            ...
            <RichEditor placeholder="Write comment" onChange={setNodes}>
                <button
                    ...
                    disabled={createComment.isPending || nodes.length === 0}
                    className="dark:highlight-white/20 h-12 rounded-lg bg-slate-900 px-6 font-semibold text-white hover:bg-slate-700 focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 focus:outline-none disabled:bg-slate-300 disabled:text-slate-400 dark:bg-sky-500 dark:hover:bg-sky-400 disabled:dark:bg-slate-600 disabled:dark:text-slate-500"
                >
                    Post comment
                </button>
            </RichEditor>
